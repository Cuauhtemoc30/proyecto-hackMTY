...
import { BarChart3, Clock, Package, Users, TrendingUp, Sparkles } from 'lucide-react';
...
type View = 'overview' | 'drawers' | 'calculator' | 'employees' | 'predictor';
...
export default function Dashboard() {
  ...
  const menuItems = [
    ...
    { id: 'predictor' as View, label: 'Predictor IA', icon: Sparkles },
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 py-6">
        <div className="flex gap-6">
          ...
          <main className="flex-1">
            ...
            {activeView === 'predictor' && <DifficultyPredictor />}
          </main>
        </div>
      </div>
    </div>
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-blue-800 mb-3">
              Los cajones de tipo Business con categoría Breakfast tienen un 25% más de complejidad
              que el promedio. El tiempo estimado de ensamblaje puede aumentar hasta 90 segundos
